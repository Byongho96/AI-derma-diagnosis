...
#ifndef AI_DERMA_DIAGNOSIS_SWIFT_H
#define AI_DERMA_DIAGNOSIS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ai_derma_diagnosis",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC18ai_derma_diagnosis11AppDelegate")
...
SWIFT_CLASS("_TtC18ai_derma_diagnosis17MainFlutterWindow")
